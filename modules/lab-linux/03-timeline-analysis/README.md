...
- **MITRE ATT&CK T1003 (OS Credential Dumping)** — real-world Procedure Examples with named campaigns and citations: https://attack.mitre.org/techniques/T1003/
- **Threat actors documented using it:** APT28, APT32, APT39, Mustang Panda (see each group's page on attack.mitre.org for the specific intrusions).
