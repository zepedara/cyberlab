...
> **New here? Start with [module 01 -- Disk & filesystem forensics](modules/lab-linux/01-disk-forensics/README.md)** and work the modules in NN order. Each path builds on the one before it.

| Path | Modules | Focus |
|---|---|---|
| **Foundations** | 01-11 | Linux DFIR fundamentals: disk, memory, timeline, registry, carving, PCAP, and malware/document triage on SIFT + REMnux. |
| **Windows RE** | 12-19 | Reverse engineering on FLARE-VM: static, dynamic, .NET, behavioral, process-memory, shellcode, and malicious Office/script analysis. |
| **Deep-dives** | 20-46 | Per-tool mastery (Volatility 3, YARA, Sleuth Kit, Plaso, Wireshark, Ghidra, x64dbg, and more). |
| **Scenarios** | 47-56 | Integrated multi-tool investigations end-to-end (ransomware, phishing, intrusion timeline, C2 hunt, unpacking). |
